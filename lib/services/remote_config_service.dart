...
class RemoteConfigService {
  ...
  double get inviteTelemetrySampleRate =>
      _remoteConfig.getDouble('telemetry_invite_sample_rate');
  // Driver Safety flags
  bool get driverSafetyEnabled =>
      _remoteConfig.getBool('driver_safety_enabled');
  double get driverSafetyThresholdBrake =>
      _remoteConfig.getDouble('driver_safety_threshold_brake');
  double get driverSafetyThresholdAccel =>
      _remoteConfig.getDouble('driver_safety_threshold_accel');
